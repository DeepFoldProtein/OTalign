...
#
# Usage: sbatch scripts/slurm_cp_train.sh [args...]
#
# Example:
# sbatch scripts/slurm_cp_train.sh \
#    --model work/checkpoints/esm1b-lora-finetune-5/checkpoint-epoch-10 \
#    --base_model_for_checkpoint ESM1b_33_650M \
#    --data_dir data/contact-dataset \
#    --batch_size 1 \
#    --epoch 10 --lr 1e-3 \
#    --outdir work/cp/esm1b-lora-finetune-5
# =================================================================================
...
#SBATCH --output=work/cp_job_%j.out  # Path for standard output log
#SBATCH --error=work/cp_job_%j.err   # Path for standard error log
...
echo "[$(date)] Starting CP training..."
echo "Arguments passed to script: $@"
accelerate launch --config_file accelerate_config.yaml scripts/run_contact_prediction.py "$@"
